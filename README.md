...
Please note that Confluent 7.3.1 version is equivalent to Apache Kafka version 3.3.1
...
nohup ./kafka-server-start ../etc/kafka/kraft/server.properties > kafka_kraft_out &
